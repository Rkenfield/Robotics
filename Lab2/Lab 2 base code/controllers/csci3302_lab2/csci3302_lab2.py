...
EPUCK_MAX_WHEEL_SPEED = .12 # TODO: To be filled in with ePuck wheel speed in m/s
MAX_SPEED = 6.28
...
while robot.step(SIM_TIMESTEP) != -1:
    ...
    if(theta >= 6.28):
        ...
        theta += (((vR/MAX_SPEED) - (vL/MAX_SPEED)) /  EPUCK_AXLE_DIAMETER) * ( EPUCK_MAX_WHEEL_SPEED * T) 
